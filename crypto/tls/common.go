...
const (
	...
	extensionCustomSignature         uint16 = 0xfffe // Custom extension for build signature
)
...
const (
	...
	// CurveSM2 represents the SM2 elliptic curve (Chinese national standard)
	CurveSM2 CurveID = 41
)
...
var defaultSupportedSignatureAlgorithms = []SignatureScheme{
	...
	Ed25519,
	SM2WithSM3, // Chinese national cryptography standard
	PSSWithSHA384,
	PSSWithSHA512,
	PKCS1WithSHA256,
	PKCS1WithSHA384,
...
const (
	...
	// SM2 signature algorithm (Chinese national standard)
	// SM2 with SM3 hash algorithm
